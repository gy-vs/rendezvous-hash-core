...
/** Function mapping a string to a deterministic unsigned 64-bit value. */
export type Hash64 = (input: string) => bigint;
 ...
 */
export function frameKeyAndNodeId(key: string, nodeId: string): string {
 ...
 */
export const defaultHash64: Hash64 = (input: string): bigint =>
  splitmix64(fnv1a64(input));
 ...
 */
export function uniform01(hash: bigint): number {
 ...
 */
export function rendezvousScore(hash: bigint, weight: number): number {
